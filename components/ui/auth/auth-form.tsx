...
import { AulliWordMark } from '~components/icons';
    ...
    <div className='flex h-full flex-col w-80 items-center justify-center p-4'>
      <div className='flex flex-col items-center pb-1 space-y-3'>
        ...
        <div className={'text-center'}>
          <p className='text-3xl font-bold font-gilroy text-foreground'>
            Access Your Account
          </p>
          <p className='text-sm text-default-500 font-medium font-inter'>
            Instant Access via Magic Link or Oauth
          </p>
        </div>
      </div>
      <div className='mt-2 flex w-full flex-col gap-6 py-6'>
        <form className='flex flex-col gap-3' action={action}>
          ...
          <Button
            ...
            type='submit'
            className={
              'font-semibold text-center hover:ring-lima-500 ring-offset-2'
            }
            radius={'md'}
            disabled={isPending}
          >
        ...
        <div className='flex flex-col gap-2'>
          <form
            action={googleAction}
            className={'w-full hover:ring-lima-500 ring-offset-2'}
          >
            <Button
